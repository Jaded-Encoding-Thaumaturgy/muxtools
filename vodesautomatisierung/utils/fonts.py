...
from font_collector.font_loader import FontLoader


def get_fonts():
    loader = FontLoader()
    doc = AssDocument.from_file(
        r"D:\Sources\Trigun Stampede\08\Trigun Stampede E08 [1080p][AAC][JapDub][GerEngSub][Web-DL]-en.ass"
    )
