...
def parse_audioinfo(file: PathLike, track: int = 0) -> AudioInfo:
    ...
    debug(f"Starting to parse frames and stats for '{file.stem}'", parse_audioinfo)
